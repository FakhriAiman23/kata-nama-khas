...
const GAME_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  /* ── GAME NAVBAR ── */
  .game-nav {
    background: linear-gradient(135deg, var(--obsidian) 0%, var(--stone) 100%);
    border-bottom: 4px solid var(--wood);
    box-shadow: 0 4px 0 rgba(0,0,0,0.8), 0 8px 0 rgba(107,76,42,0.3);
  ...
  .btn-pixel {
    ...
    box-shadow: 4px 4px 0 #000, inset 0 1px 0 rgba(255,255,255,0.1);
  ...
  .btn-pixel:hover {
    background: linear-gradient(135deg, var(--dirt), var(--cobble));
    color: var(--gold);
    transform: translateY(-3px);
    box-shadow: 6px 6px 0 #000, inset 0 1px 0 rgba(255,255,255,0.1);
  }
  .btn-pixel:active {
  ...
  .btn-pixel-gold:hover { color: #000; filter: brightness(1.1); }
  .btn-pixel-green  { background: linear-gradient(135deg, #1b5e20, #00C853); border-color: #1b5e20; }
  .btn-pixel-green:hover { color: #fff; }
  .btn-pixel-red    { background: linear-gradient(135deg, #7f0000, #E53935); border-color: #7f0000; }
  .btn-pixel-blue   { background: linear-gradient(135deg, #0d47a1, #1E88E5); border-color: #0d47a1; }
  .btn-pixel-purple { background: linear-gradient(135deg, #4a148c, #8E24AA); border-color: #4a148c; }
  ...
  .option-btn {
    font-family: var(--pixel);
    font-size: 0.55rem;
    background: linear-gradient(135deg, var(--dirt) 0%, var(--cobble) 100%);
    color: var(--cream);
    border: 3px solid var(--wood);
    box-shadow: 3px 3px 0 #000;
    padding: 1rem;
  ...
  .option-btn:active:not(:disabled) { transform: translateY(1px); box-shadow: 1px 1px 0 #000; }
  .option-btn:disabled { opacity: 0.6; cursor: not-allowed; }
  .option-btn.correct-ans {
    background: linear-gradient(135deg, #1b5e20, var(--emerald)) !important;
    border-color: var(--emerald) !important;
    color: #fff !important;
    box-shadow: 3px 3px 0 #000, var(--glow-green) !important;
    animation: pixelPulse 0.5s;
  }
  .option-btn.wrong-ans {
    background: linear-gradient(135deg, #7f0000, var(--ruby)) !important;
    border-color: var(--ruby) !important;
    color: #fff !important;
    box-shadow: 3px 3px 0 #000, var(--glow-red) !important;
  ...
  return (
    <nav className="game-nav">
      <div className="d-flex align-items-center justify-content-between flex-wrap gap-2">
        <div className="brand">⚔️ KNK Game</div>
        <div className="d-flex gap-2 flex-wrap">
          <button className="nav-btn" onClick={() => setPage("home")}>🏠 {page !== "home" && "Utama"}</button>
          <button className="nav-btn" onClick={() => setPage("lyrics")}>🎵 Lagu</button>
          <button className="nav-btn" onClick={() => setPage("levels")}>🎮 Peringkat</button>
        </div>
      </div>
    </nav>
  );
